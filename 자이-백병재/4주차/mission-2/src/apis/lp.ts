import type { CursorBasedResponse, ResponseLikes, PaginationDTO, ResponseLpDetailDTO, ResponseLpDTO, CreateLpBody, CreateLpResponse, CreateLpParams, FixLpParams, DeleteLpResponse } from './../types/lp';
...
export const fixLp = async({lpId, title, content, thumbnail, tags}: FixLpParams): Promise<CreateLpResponse> => {
    const requestBody: CreateLpBody = { title, content, thumbnail, tags, published: true }
